...
### Your application container name will correspond with "project_slug": allegro_suppliers
...
## even can explicitly point which one by means of:
    ...
    docker compose -f compose_stack.yml up --build allegro_suppliers

## to make migration you can execute command inside docker app container like this:

    docker container exec allegro_suppliers_app poetry run alembic upgrade head
...
Go to your GitHub account and create a new repo that matches the **allegro_suppliers** 
